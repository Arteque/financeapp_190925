...
const MainHeader = () => {
  ...
  return (
    ...
    lg:sticky lg:top-0 lg:bottom-0 lg:left-0 lg:max-w-[600px] lg:rounded-lg lg:m-10">
      ...
      </Link>
      {
        !isLogged ? (
            <figure className="hidden lg:block">
              <img src="/images/illustration-authentication.svg" alt="Authentication Illustration" className="w-full h-full object-contain"/>
              <figcaption>
                <h2>
